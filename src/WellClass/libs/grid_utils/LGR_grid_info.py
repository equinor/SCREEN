...
class LGRGridInfo:
    def __init__(self, grid_coarse: GridCoarse, annulus_df: pd.DataFrame, holes_df: pd.DataFrame, Ali_way: bool):
    ...
    def _compute_min_grd_size(self, annulus_df: pd.DataFrame, Ali_way: bool) -> float:
    ...
    def _compute_num_lateral_fine_grd(self, holes_df: pd.DataFrame) -> float:
    ...
    def _compute_LGR_sizes_xy(self, Ali_way: bool) -> Tuple:
        ...
        LGR_sizes_x, LGR_sizes_y, _ = generate_LGR_xy(num_lateral_fine_grd, min_grd_size, main_grd_dx, main_grd_dy, Ali_way=Ali_way)
