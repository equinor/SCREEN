...
def parameterize_grdecl(
    ...
    *,
    ...
    dx: float = 200.0,
    dy: float = 200.0,
    reservoir_permx: float = 1000.0,
    overburden_permx: float = 0.001,
    ...
    lines = [
        ...
        region("PERMX", overburden_permx, overburden_start, overburden_end),
...
def stage_case(args: argparse.Namespace) -> tuple[Path, Path, Path]:
    ...
    parameterize_grdecl(
        ...
        reservoir_permx=getattr(args, "reservoir_permx", 1000.0),
        overburden_permx=getattr(args, "overburden_permx", 0.001),
